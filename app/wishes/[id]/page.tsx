  ...
  return (
    <div className="flex flex-col min-h-screen bg-white max-w-[440px] mx-auto border-x border-border">
      ...
      <ScrollArea className="flex-1">
        <div className="p-5">
          {/* Image */}
          <div className={`w-full aspect-square rounded-xl border border-border mb-5 ${wishData.bgColor}`} />
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <Badge className="bg-green-500 hover:bg-green-600 text-white">-{wishData.discount}%</Badge>
          </div>
          ...
          <div className="my-5">
            ...
            <p className="text-muted-foreground leading-relaxed">{wishData.description}</p>
          </div>
